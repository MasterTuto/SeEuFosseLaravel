...
- Que passa a expressao, a pilha vazia para resolver a expressao, e a String acumuladora. 
-}
...
- saida:      IO Double (resultado da expressao); 
- suposicoes: supoe-se que a expressao seja passada corretamente no input. 
- algoritmo:  Na linha 73 vai avaliar se a nao foi passada uma expressao, retornando a mensagem error. 
- Na linha 74 se a expressao estiver vazia e a pilha nao, entao ele vai retornar o elemento do topo da pilha com o resultado.
- Da linha 75 para baixo eh o funcionamento da pilha na resolucao da expressao. 
